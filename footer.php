<footer class="dark-footer">
    ...
    <div class="sub-footer">
      <div class="container"> <span class="copyright">Copyright © 2015 , Shipper Logistic | Transportation Template </span></div>
      <!-- end container --> 
    </div>
    <!-- end sub-footer --> 
  </footer>
...
<!-- Mirrored from themezinho.net/shipper/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 29 Jan 2020 06:31:27 GMT -->
</html>